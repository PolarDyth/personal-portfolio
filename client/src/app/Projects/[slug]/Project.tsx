    ...
    <div>
      ...
      <div className="mb-16 text-left">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          <p className="text-muted-foreground leading-relaxed whitespace-pre-line">{projects.data.overview}</p>
        </div>
      </div>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
        ...
        <div>
          <ProjectTestimony quote={projects.data.testimonial.quote} author={projects.data.testimonial.author} />
        </div>
      </div>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
        <div className="lg:col-span-2">
          ...
          <div className="border border-border rounded-xl p-6">
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              <p className="text-muted-foreground leading-relaxed whitespace-pre-line">{projects.data.process}</p>
            </div>
          </div>
        </div>
        <div>
